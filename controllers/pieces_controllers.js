...
async function createPiece(req) {
  let piece = new Pieces({
    ...
    numeratorLength: req.body.numeratorLength,
    denominatorLength: req.body.denominatorLength,
    numeratorWidth: req.body.numeratorWidth,
    denominatorWidth: req.body.denominatorWidth,
